...
static struct clkctl_acpu_speed  msm72xx_tbl[] = {
	...
	{ 122880, ACPU_PLL_0, 4, 1, 61440, 1, VDD_2, 61440, 0, 0, 4, 10 },
#if 1 /* QCT fixup */
	{ 160000, ACPU_PLL_1, 1, 5, 53333, 2, VDD_2, 61440, 0, 0, 6, 50 },
#else /* Google */
	{ 160000, ACPU_PLL_1, 1, 5, 64000, 1, VDD_2, 61440, 0, 0, 6, 50 },
#endif
	{ 176000, ACPU_PLL_2, 2, 5, 88000, 1, VDD_2, 61440, 0, 0, 5, 55 },
	{ 245760, ACPU_PLL_0, 4, 0, 81920, 2, VDD_3, 61440, 0, 0, 5, 10 },
	{ 352000, ACPU_PLL_2, 2, 2, 88000, 3, VDD_4, 128000, 0, 3, 7, 55 },
#if 1 /* QCT fixup */
	{ 480000, ACPU_PLL_1, 1, 1, 120000, 3, VDD_5, 120000, 0, 2, 7, 50 },
#else /* Google */
	{ 480000, ACPU_PLL_1, 1, 1, 128000, 2, VDD_5, 160000, 0, 2, 7, 50 },
#endif
	{ 528000, ACPU_PLL_2, 2, 1, 132000, 3, VDD_6, 160000, 0, 5, 12, 55 },
	{ 604800, ACPU_PLL_2, 2, 1, 151200, 3, VDD_6, 160000, 0, 7, 12, 63 },
	{ 710400, ACPU_PLL_2, 2, 0, 156000, 3, VDD_6, 160000, 0, 7, -1, 37 },
	{ 729600, ACPU_PLL_2, 2, 0, 160800, 3, VDD_6, 160000, 0, 7, -1, 38 },
	{ 748800, ACPU_PLL_2, 2, 0, 187200, 3, VDD_6, 160000, 0, 7, -1, 39 },
	{ 768000, ACPU_PLL_2, 2, 0, 192000, 3, VDD_6, 160000, 0, 7, -1, 40 },
...
unsigned long acpuclk_power_collapse(int from_idle)
{
	...
	if (from_idle)
		acpuclk_set_rate(drv_state.power_collapse_khz, SETRATE_PC_IDLE);
	else
